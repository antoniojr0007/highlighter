...
public class SugestaoSerieActivity extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sugestao_serie);
    ...
    public void carregarWebService(View view) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        String url = Servidor.mostrarServidor() +"sugestaoSerie.php?nomeSerie="+campoTitulo.getText().toString()+"&lancamento="+campoAno.getText().toString()+"&produtora="+campoProdutora.getText().toString()+"";
    ...
    public void CancelarSugestao (View view){
        LimparTela();
        Intent intent = new Intent( SugestaoSerieActivity.this, MainActivity.class);
